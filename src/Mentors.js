    ...
    return (
        <div className='mx-4 lg:mx-20 mt-4'>
            ...
            <div className='grid lg:grid-cols-3 gap-6 mt-4 mb-10'>
                ...
                <MentorCard source="/mentorImages/tyler.png" name="Tyler Marrazzo" bio="Tyler is a senior at James B. Conant High School and wishes to study engineering in the future. He participates in Finance Club and is on the Student Council Executive Board."></MentorCard>
