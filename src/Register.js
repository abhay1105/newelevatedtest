        ...
        <div className='mx-4 lg:mx-20'>
            ...
            <div className='mt-4 mb-12'>
                <div className='grid lg:grid-cols-2 mt-4 gap-6'>
                    <Program title={"SAT / AP Prep"} description={"These high school test preparation sessions are run by high school seniors with recent experience in taking several SAT & AP tests.They will provide younger students with the tips and skills that have allowed them to get exceptional scores."} day={"Sundays"} timeText={"1: 00 -- 2: 30 PM Central Time"} mentorsText={"Prisha Mohan & Ezra Goodwin"} locationText={"Schaumburg Township Library"} locationType={"link"} programType={"In - Person"} newProgram={true} />
                    {/* <div className='flex p-8 justify-between space-x-4 border border-main-shadow rounded-lg'>
                        ...
                        <div className='w-1/2 bg-main relative'>
                            ...
                            <div className='py-4 px-4 space-y-6 h-full flex items-center flex-col justify-center'>
                                ...
                                <div className='text-center'>
                                    ...
                                    <a target="_blank" href='https://www.google.com/maps/place/Schaumburg+Township+District+Library/'><p className='underline'>Schaumburg Township Library</p></a>
                                </div>
                    ...
                    <div className='flex p-8 justify-between space-x-4 border border-main-shadow rounded-lg'>
                        ...
                        <div className='w-1/2'>
                            <div className='bg-main py-8 px-4 space-y-6 h-full flex items-center flex-col justify-center'>
                                <div className='text-center'>
                                    <p className='text-2xl font-semibold'>Sundays</p>
                    ...
                    <div className='flex p-8 justify-between space-x-4 border border-main-shadow rounded-lg'>
                        <div className='flex w-1/2'>
                            <div className=''>
                                <div className='flex space-x-4 items-center'>
                                    <p className='text-xl font-semibold'>Business Fundamentals</p>
                                    <div className='bg-orange-200 rounded-full px-2 py-1'>
                                        <p>Virtual</p>
                                    </div>
                                </div>
